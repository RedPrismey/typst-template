...
#let init(type: [], title: [], authors: [], info: [], date: [], decoration: "assets/uphf.png", desc: [], allowance: 255pt, outline_depth: 3, preamble: [], doc) = {
...
#let remark(content, type: types.info) = {
  pad(
    block(
      pad(
        grid(
          ...
          align(
            horizon,
            block(
              image(type.icon, width: 25pt, height: 25pt ),
              //fill : level.accent,
              radius: 10pt,
            )
          ),
